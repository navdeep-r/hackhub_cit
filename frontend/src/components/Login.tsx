                ...
                <div className="glass-panel p-1 rounded-2xl shadow-2xl relative overflow-hidden border border-slate-800/50 bg-slate-900/40 backdrop-blur-xl">
                    ...
                    <div className="grid grid-cols-2 gap-1 p-1 bg-slate-950/50 rounded-xl mb-6">
                        <button
                            ...
                            className={`py-3 rounded-lg text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 ${mode === 'LOGIN'
                        ...
                        <button
                            ...
                            className={`py-3 rounded-lg text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 ${mode === 'SIGNUP'
                                ? 'bg-blue-600 text-white shadow-lg'
                                : 'text-slate-500 hover:text-slate-200 hover:bg-slate-800/50'
                                }`}
                        >
                    ...
                    <div className="px-6 pb-8">
                        {/* 2. Role Display (Student Only - Non-interactive) */}
                        <div className="flex justify-center mb-6">
                            <div className="inline-flex p-1 bg-slate-900/80 rounded-lg border border-slate-700/50">
                                <div className="px-6 py-2 rounded-md text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-cyan-600 to-blue-600 text-white shadow-md flex items-center gap-2">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-1 animate-slide-up" style={{ animationDelay: '50ms' }}>
                                <label className="text-xs font-bold text-slate-400 ml-1 uppercase tracking-wide">
                                    Email Address <span className="text-cyan-400 normal-case ml-1 font-normal">(@citchennai.net)</span>
                                </label>
                                <div className="relative group">
